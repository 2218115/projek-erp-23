...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('produk') . '/' . $produk->id . '/edit' }}"> Edit</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('produk/' . $produk->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('referensi_internal', $produk->referensi_internal) }}" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('harga_jual') is-invalid @enderror"
                                        ...
                                        value="{{ old('harga_jual', $produk->harga_jual) }}" step="0.01" />
                                    @error('harga_jual')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ url('produk') . '/' . $produk->id }}" class="btn btn-secondary w-48">Batal</a>
